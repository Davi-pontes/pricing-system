import { IProduct, ISingleProduct, IUpdateProductParams } from "@/interfaces/product";
...
export class FormatedDatas {
  ...
  static formatedDatasToUpdateProduct(datas: ISingleProduct): IUpdateProductParams {
    const newData = {
      name: datas.nameProduct,
      income: datas.qtdInBox,
      recipe_time: 0,
